...
const resources = {
  ...
  gr: {
    translation: {
      ...
      projects: {
        title: 'Τα Έργα Μου',
        text: 'Ιδού μερικά από τα project στα οποία έχω δουλέψει! Κάθε έργο αντανακλά το πάθος μου για τον προγραμματισμό, την επίλυση προβλημάτων και τη δημιουργία συναρπαστικών εμπειριών για τον χρήστη.',
        ...
        categories: {
          ...
          mobileApp: 'Mobile Εφαρμογές',
        },
        projectsData: {
          id6: {
            title: 'Η Πτυχιακή μου Εργασία',
            description:
              'Η πτυχιακή εργασία στην οποία δούλεψα έχει τον τίτλο "Βελτίωση και ενσωμάτωση στοιχείων παιχνιδοποίησης στην εφαρμογή επαυξημένης πραγματικότητας ePhos AR". Το ePhos AR είναι μια εκπαιδευτική εφαρμογή που εισάγει νέους μαθητές στην επιστήμη της Φωτονικής, αξιοποιώντας την τεχνολογία της επαυξημένης πραγματικότητας (Augmented Reality - AR).\n\nΗ συμβολή μου επικεντρώθηκε στη διόρθωση σφαλμάτων και την ενσωμάτωση στοιχείων παιχνιδοποίησης, ώστε να ενισχυθεί το ενδιαφέρον των χρηστών — μια προσέγγιση που υποστηρίζεται από πολλαπλές επιστημονικές έρευνες. Συγκεκριμένα, πρόσθεσα:\n\n-Έναν εικονικό βοηθό που καθοδηγεί τους χρήστες καθ\'όλη τη διάρκεια του παιχνιδιού, αντικαθιστώντας τις παραδοσιακές έντυπες οδηγίες.\n-Μια μπάρα προόδου για την οπτική αναπαράσταση της πορείας του παίκτη.\n-Κονκάρδες (badges) που λειτουργούν ως επιβράβευση για τα επιτεύγματα του χρήστη και ως κίνητρο για περαιτέρω εξερεύνηση.\n\nΑυτά τα χαρακτηριστικά αναπτύχθηκαν στο περιβάλλον της Unity με C# μέσα σε έξι μήνες αφοσιωμένης εργασίας και έρευνας. Ο στόχος ήταν να γίνει η μάθηση πιο διαδραστική, ευχάριστη και αποτελεσματική.',
          },
          id5: {
            title: 'Viva Customers',
            description:
              'Για την καλύτερη διαχείριση της 3D Printing επιχείρησής μου, ανέπτυξα την εφαρμογή Viva Customers με Java Swing, η οποία αποθηκεύει τα στοιχεία πελατών και το ιστορικό πωλήσεων σε μια βάση SQL. Μέσα από αυτό το project, έμαθα να κατασκευάζω ένα ευέλικτο περιβάλλον χρήστη σε συνδυασμό με την αποτελεσματική διαχείριση βάσεων δεδομένων, δημιουργώντας ένα ελαφρύ πρόγραμμα που τρέχει ομαλά σε οποιονδήποτε υπολογιστή των Windows.',
          },
          id4: {
            title: 'FortKnight',
            description:
              'Ως λάτρης του σκάκι, συνέβαλα στην ανάπτυξη του FortKnight, μια εκδοχή με μοναδικούς κανόνες η οποία τρέχει στον browser. Πρόσθεσα έναν διακόπτη που εμφανίζει τις πιθανές κινήσεις του ίππου με πράσινες κουκκίδες, βελτιώνοντας την κατανόηση για τον παίκτη. Η συνεισφορά μου απαιτούσε να εξοικειωθώ με έναν άγνωστο κώδικα γραμμένο σε HTML, CSS και JavaScript, ενισχύοντας τόσο τις προγραμματιστικές μου δεξιότητες όσο και την προσαρμοστικότητά μου σε νέα project.',
          },
          id3: {
            title: 'Run 4 Life (Βιντεοπαιχνίδι)',
            description:
              'Το Run 4 Life είναι ένα 3D παιχνίδι δράσης που ανέπτυξα στο πλαίσιο ενός πανεπιστημιακού project. Σε αυτό το παιχνίδι, ο παίκτης πρέπει να αποφύγει εμπόδια, να μαζέψει διαμάντια και να φτάσει στη γραμμή τερματισμού. Ήταν η πρώτη μου εμπειρία που συνδύασε 3D γραφικά, ηχητικά εφέ και animation, όλα υλοποιημένα με Unity και C#.',
          },
          id2: {
            title: 'The Number (Βιντεοπαιχνίδι)',
            description:
              'Στα 15 μου ανέπτυξα το The Number, με το περιβάλλον του Game Maker Studio. Σε αυτό, ο παίκτης καλείται να σκεφτεί έναν αριθμό από το 1 έως το 31, και το παιχνίδι τον μαντεύει μέσα από μια σειρά έξυπνων ερωτήσεων.',
          },
          id1: {
            title: 'Το πρώτο μου βιντεοπαιχνίδι - Maze Rush',
            description:
              'Σε ηλικία 14 ετών, δημιούργησα το πρώτο μου βιντεοπαιχνίδι χρησιμοποιώντας το Game Maker Studio — μια εμπειρία που πυροδότησε το πάθος μου για τον προγραμματισμό. Στο παιχνίδι αυτό, ο παίκτης ελέγχει έναν χαμογελαστό χαρακτήρα που προσπαθεί να διασχίσει πολύπλοκους λαβυρίνθους γεμάτους εχθρούς και εμπόδια, με στόχο να φτάσει στην πύλη που οδηγεί στο επόμενο επίπεδο. Το project αυτό αποτέλεσε το πρώτο μου βήμα στον κόσμο του προγραμματισμού και της ανάπτυξης διαδραστικών εμπειριών.',
          },
        },
      },
      contact: {
